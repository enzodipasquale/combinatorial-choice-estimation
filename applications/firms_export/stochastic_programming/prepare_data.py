"""
Data preparation for the stochastic programming (SP) estimation of firms' export
destination choices.  Merges raw trade data loading, CEPII gravity feature
construction, and the SP-specific panel builder into a single module.
"""
...
# ═══════════════════════════════════════════════════════════════════════
# Expected revenue via iterative proportional fitting
# ═══════════════════════════════════════════════════════════════════════
...
def build_all_gravity_features(dataframe, home=None):
    """Build all gravity features.  Uses DATA_DIR for the CEPII cache."""
...
# ═══════════════════════════════════════════════════════════════════════
# SP context builder: firm-year panel for two-stage estimation
# ═══════════════════════════════════════════════════════════════════════
...
def build_context(dataframe, expected_revenue, pairwise_features,
    ...
    # and whose entry year allows at least end_buffer years of data
...
def build_input_data(ctx, R):
    """Build input_data dict for the TwoStageSolver."""
    return {
        "id_data": {
