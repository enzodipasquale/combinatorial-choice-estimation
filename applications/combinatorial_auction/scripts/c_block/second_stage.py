...
def _xbar_at_obs_bundles(ctx, b_obs, mod_names, quad_names, qid_names):
    """Aggregate covariate x̄_k at observed bundles (= LP column coefficients under BLP inversion)."""
    xbar = {}
...
def report(config_stem):
    ...
    print(f"  {'  Entropy of choice (ObjVal/S)':<{W}}  {entropy.mean():>10.2f}  {entropy.std():>10.2f}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("configs", nargs="*", default=["boot", "boot_3", "boot_5"])
