...
def main():
    ...
    # Setup scenario with rho correlation method
    true_rho = 0.5
    ...
    if rank == 0:
        ...
        ax1.set_title('Moment Distance vs Rho (with Warm-Start)', fontsize=14)
        ...
        plt.tight_layout()
        plt.savefig('experiments/Gentzkow/rho_correlation_method/rho_search_moments_warmstart.png', dpi=150, bbox_inches='tight')
        print("Plot saved to: experiments/Gentzkow/rho_correlation_method/rho_search_moments_warmstart.png")
        print()
        ...
        ax.set_title('Moment Distance vs Rho (with Warm-Start)', fontsize=16, fontweight='bold')
        ax.grid(True, alpha=0.3)
        ax.legend(fontsize=12)
        ax.set_xlim(min(rhos) - 0.05, max(rhos) + 0.05)
        plt.tight_layout()
        plt.savefig('experiments/Gentzkow/rho_correlation_method/rho_search_moment_distance_warmstart.png', dpi=150, bbox_inches='tight')
        print("Single plot saved to: experiments/Gentzkow/rho_correlation_method/rho_search_moment_distance_warmstart.png")
        print()
