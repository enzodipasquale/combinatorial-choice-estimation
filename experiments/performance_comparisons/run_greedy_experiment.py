#!/usr/bin/env python3
"""
Greedy experiment only - 2 medium-scale configurations.
"""
...
def main():
    """Run greedy experiments for both medium-scale configurations."""
    print("="*80)
    print("GREEDY EXPERIMENTS: Standard vs 1slack Formulations")
    print("="*80)
