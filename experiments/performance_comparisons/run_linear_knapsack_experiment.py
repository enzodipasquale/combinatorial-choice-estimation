#!/usr/bin/env python3
"""
Linear knapsack experiment only - 2 medium-scale configurations.
"""
...
def main():
    """Run linear knapsack experiments for both medium-scale configurations."""
    print("="*80)
    print("LINEAR KNAPSACK EXPERIMENTS: Standard vs 1slack Formulations")
    print("="*80)
