"""
Debug SE with POSITIVE fixed effects - Greedy only.
FE true params > 0, bounds [0, 10].
Compare with debug_se_with_fe.py (FE in [-5, 5]).
"""
import numpy as np
...
def main():
    ...
    # Bounds: FE >= 0 (POSITIVE)
    theta_lbs = [0.0, 0.0] + [0.0] * num_fe  # FE bounded [0, 10]
    theta_ubs = [15.0, 3.0] + [10.0] * num_fe
    ...
    if rank == 0:
        ...
        print("\n" + "=" * 100)
        print("RESULTS (POSITIVE Fixed Effects)")
        print("=" * 100)
