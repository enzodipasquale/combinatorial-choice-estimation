...
if rank == 0:
    ...
    master_pb, vars_tuple= init_master(epsilon_si_j, modular_i_j_k, quadratic_j_j_k, num_simulations = NUM_SIMULATIONS)
...
for iteration in range(MAX_ITERS):
    ...
    local_new_rows = [solve_pricing(pricing_pb, local_modular[ell], quadratic_j_j_k, lambda_k_iter, p_j_iter) 
    ...
    if rank == 0:
        ...
        stop = solve_master(master_pb, vars_tuple, pricing_results, slack_counter,
