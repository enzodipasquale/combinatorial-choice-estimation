...
class QuadraticSupermodular(BatchSubproblemBase):
    ...
    def initialize(self) -> None:
        ...
        if self.has_modular_agent:
            self.modular_agent = self.data_manager.local_data["agent_data"]["modular"]
        ...
        if self.has_quadratic_agent:
            self.quadratic_agent = self.data_manager.local_data["agent_data"]["quadratic"]
