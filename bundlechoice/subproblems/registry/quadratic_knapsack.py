...
class QuadraticKnapsackSubproblem(SerialSubproblemBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._last_bundles: Optional[NDArray[np.bool_]] = None
    ...
    def solve(self, local_id, theta, pb):
        output_flag = self.config.settings.get('OutputFlag', 0)
        gurobi_logger = logging.getLogger('gurobipy')
        ...
        try:
            ...
            try:
                ...
                elif self._last_bundles is not None and local_id < len(self._last_bundles):
