...
class ColumnGenerationManager(BaseEstimationManager):
    ...
    def _solve_pricing_problem(self, dual_prices, agent_penalties):
        ...
        try:
            ...
            raise
        bundles_all = self.comm_manager._gather_array_by_row(local_bundles, root=0)
    ...
    def _master_iteration(self):
        ...
        dual_prices = self.comm_manager._broadcast_array(dual_prices, root=0)
        agent_penalties = self.comm_manager._broadcast_array(agent_penalties, root=0)
