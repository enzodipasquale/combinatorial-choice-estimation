...
def initialize_pb(modular_characteristics_i_j_k, quadratic_characteristic_j_j_k, matching_i_j):
    ...
    # Non negativity
    model.addConstr(lambda_k[2] >= 0, name="lambda_2_nonnegative")
    model.addConstr(lambda_k[3] >= 0, name="lambda_3_nonnegative")
...
# solution_master_pb[0] = 1000
# solution_master_pb[1] = 1000
# solution_master_pb[2] = 0
# solution_master_pb[3] = 0
